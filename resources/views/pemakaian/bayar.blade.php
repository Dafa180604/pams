...
@section('content')
    <div class="page-content">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('pemakaian.index') }}">Data Master Transaksi</a></li>
            ...
            <div class="col-md-12 stretch-card">
                <div class="card shadow">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-2 flex">
                                            ...
                                            <span class="fw-bold">{{ $data->pemakaian->users->id_users }}</span>
                                        </div>
                                        <div class="mb-2 flex">
                                            <span class="text-muted w-32">Nama Pelanggan:</span>
                                            <span class="fw-bold">{{ $data->pemakaian->users->nama }}</span>
                                        </div>
                                        <div class="mb-2 flex">
                                                ...
                                                @foreach($kategoriList as $kategori)
                                                    <tr>
                                                        <th class="text-muted">{{ $kategori['volume'] }} m³ × Rp
                                                            {{ number_format($kategori['tarif'], 0, ',', '.') }}</th>
                                                        <td class="text-end">Rp
                                                            {{ number_format($kategori['subtotal'], 0, ',', '.') }}</td>
                                                    </tr>
                                                @endforeach
                        ...
                        <form action="{{ route('pemakaian.update', $data->id_transaksi) }}" method="POST" class="mt-4"
                            id="paymentForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mt-4">
                                <div class="col-12 d-flex justify-content-end">
                                    <a href="{{ route('pemakaian.index') }}" class="btn btn-secondary me-2"
